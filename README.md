...
Linux port by Rafal Rozestwinski (callsign: SO2A, https://rozestwinski.com), project home: https://github.com/webft8/Si5351Arduino4Linux
...
Do not use RPI 3.3V for power (low current limit). Most Si5351 modules have internal regulator 5V->3.3V anyway.
